...
function swift_install_config() {
	...
	## swift_file_account
	ops_add $swift_file_account DEFAULT bind_ip $OBJECT2_IP
	...
	ops_add $swift_file_container DEFAULT bind_ip $OBJECT2_IP
	...
	## swift_file_object
	ops_add $swift_file_object DEFAULT bind_ip $OBJECT2_IP
