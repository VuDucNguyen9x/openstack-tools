...
function nova_config () {
	...
	ops_add $novafile DEFAULT transport_url rabbit://openstack:$RABBIT_PASS@$CTL_MANAGE_IP
	ops_add $novafile DEFAULT my_ip $COM_MANAGE_IP
	...
	ops_add $novafile vnc novncproxy_base_url http://$CTL_MANAGE_IP:6080/vnc_auto.html
