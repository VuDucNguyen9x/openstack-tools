...
auto $BLOCK_MANAGE_INTERFACE
iface $BLOCK_MANAGE_INTERFACE inet static
address $BLOCK_MANAGE_IP
netmask $MANAGE_NETMASK

# The Provider Network
auto $BLOCK_PROVIDER_INTERFACE
iface $BLOCK_PROVIDER_INTERFACE inet static
address $BLOCK_IP_PROVIDER
