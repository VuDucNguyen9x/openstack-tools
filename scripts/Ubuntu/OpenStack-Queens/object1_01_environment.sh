...
# Function update and upgrade for Object1 Storage
function update_upgrade () {
	echocolor "Update and Update OBJECT1 STORAGE"
	sleep 3
...
function install_ntp () {
	...
	sed -i 's|'"pool 2.debian.pool.ntp.org offline iburst"'| \
        '"server $CTL_MANAGE_IP iburst"'|g' $ntpfile
...
# Update and upgrade for Object1 Storage
update_upgrade
