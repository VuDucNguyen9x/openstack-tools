...
hostnamectl set-hostname $COM_HOSTNAME
...
auto $COM_MANAGE_INTERFACE
iface $COM_MANAGE_INTERFACE inet static
address $COM_MANAGE_IP
netmask $MANAGE_NETMASK

# The Provider Network
auto $COM_PROVIDER_INTERFACE
iface $COM_PROVIDER_INTERFACE inet static
address $COM_IP_PROVIDER
netmask $PROVIDER_NETMASK
gateway $PROVIDER_GATEWAY
dns-nameservers $PROVIDER_DNS

# The tenant interface
auto $COM_TENANT_INTERFACE
iface $COM_TENANT_INTERFACE inet static
address $COM_TENANT_IP
...
## Reboot
echocolor "Reboot $COM_HOSTNAME node"
init 6
